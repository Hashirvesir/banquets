                ...
                <div className="w-[350px] h-[250px] mt-5 md:mt-0 bg-[#F3F3F9] rounded-md  p-4">
                    <div className="flex justify-between items-center">
                        <div className="w-13 h-11 border rounded-xl border-red-500">
                            ...
                            <button className="bg-transparen  border border-black w-[45%] p-2 mt-4 rounded-xl hover:bg-[#F00000] hover:text-white hover:border-[#F00000] ">Approved</button>
                            <button className="bg-transparen  border border-black w-[45%] p-2 mt-4 rounded-xl hover:bg-[#F00000] hover:text-white hover:border-[#F00000] ">Reject</button>
                            </div>
                </div>
                <div className="w-[350px] h-[250px] mt-5 md:mt-0 bg-[#F3F3F9] rounded-md  p-4">
                    <div className="flex justify-between items-center">
