        ...
        <div className='md:w-1/2 w-full md:h-[100vh] p-10 min-h-[50vh]'>
            ...
            <Image src='/logo.png' width={140} height={140} alt='logo' className='w-[140px] ' />
              <div className='flex flex-col  md:w-[80%] w-full '>
                ...
                <button className='border-2 font-semibold hover:bg-[#F00000] hover:text-white transition ease-in-out delay-150 border-[#F00000] w-[90%] rounded-md p-2 text-[#F00000]'>sign in with Google</button>
              </div>
            </div>
        </div>
      </div>
